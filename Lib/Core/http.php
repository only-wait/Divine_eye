...
'http://www.pku.edu.cn/index.htm',
'http://www.bnu.edu.cn/index.htm'
);
...
class request_http extends Threaded
{
        private $urls=[];
        #定义不允许爬取的后缀
        private $ext = ["jpg","gif","png","bmp","pdf","mp4","mp3","doc","rar","docx","xls","xlsx","zip","7z"];
...
$files = [];
$pool = new Pool(127,"request",array());
$pool->submit(new request_http($connomains));
$pool->shutdown();
?>